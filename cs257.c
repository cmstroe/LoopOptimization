...
void init() {
	...
	ax = (float*) _mm_malloc(N * sizeof(float), 32);
	ay = (float*) _mm_malloc(N * sizeof(float), 32);
	az = (float*) _mm_malloc(N * sizeof(float), 32);
    vx = (float*) _mm_malloc(N * sizeof(float), 32);
	vy = (float*) _mm_malloc(N * sizeof(float), 32);
    vz = (float*) _mm_malloc(N * sizeof(float), 32);
	m = (float*) _mm_malloc(N * sizeof(float), 32);
